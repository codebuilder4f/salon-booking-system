package com.mpb.salon.bookig.system.security.jwt;
...
/**
 * Class for handling the token validation
 */
@Component
public class JwtUtils {
    ...
    private int jwRefreshExpirationMs;
    ...
    public String generateJwtRefreshToken(Authentication authentication) {
        ...
        return Jwts.builder()
                .setSubject((userPrincipal.getUserName()))
                .setIssuedAt(new Date())
                .setExpiration(new Date((new Date()).getTime() + jwRefreshExpirationMs))
